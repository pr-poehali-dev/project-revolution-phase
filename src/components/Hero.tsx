  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Деревня,
          <span className="block text-sage">где дышит земля</span>
        </h1>
        ...
        >
          Ключи — небольшая деревня с большой природой. Четыре сезона, каждый со своим характером и красотой.
        </p>
